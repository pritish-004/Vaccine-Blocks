...
function Blockchain() {
    ...
    // fetch blockchain data from start value to the end value
    // used in case of Pagination
    ...
    // fetch number of blocks in blockchain
    useEffect(() => {
    ...
    // set the number of blocks in blockchain to display on each page
    const buttonNumbers = [];
