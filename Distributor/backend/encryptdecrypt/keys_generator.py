...
def KeysGenerator(password,address):
    ...
    try:
        ...
        for file in os.listdir("."):
            if os.path.isfile(file) and file.startswith("dist_p"):
                try:
        ...
        with open("./keypairs/dist_priv_"+address+".pem", 'wb') as key_file:
            key_file.write(pem_private)
        with open("./keypairs/dist_pub_"+address+".pem", 'wb') as key_file:
        ...
        # load private key
        with open("./keypairs/dist_priv_"+address+".pem", "rb") as key_file:
        ...
        # load public key
        with open("./keypairs/dist_pub_"+address+".pem", "rb") as key_file:
...
if __name__ == '__main__':
    # demonstrate method
    key_generator_manufacturer("pritish123","lmnopqir")